        ...
        if (this.value != 0) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#total_ship").html(`<p class="font-weight-bold">Phí ship</p>
                        <p class="font-weight-bold">${formatVND(result.data.total)}</p> `);
                                        
                    $("#total_checkout").html(`<p class="font-weight-bold">Tổng tiền</p>
                        <p class="font-weight-bold">${formatVND(result.data.totaloder)}</p> `);
